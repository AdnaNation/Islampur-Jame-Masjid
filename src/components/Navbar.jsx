...
<div className="flex  items-center ml-4">
      ...
      <a className="btn btn-ghost text-2xl text-black font-bold font-sans flex-1">Islampur Jame Masjid</a>
        ...
        >
          ...
          <ul className="p-4 space-y-4  max-w-[300px] z-auto  ">
            <li className="flex justify-between items-center hover:bg-white hover:text-black rounded-md">
              <NavLink className="border border-black border-1 font-bold w-full px-3 py-1 rounded-md" to="/">
                Home
              </NavLink>
            </li>
            <li className="flex justify-between items-center hover:bg-white hover:text-black rounded-md">
